...
const ICONS = {
  ...
  home: '<svg viewBox="0 0 16 16"><path d="M2.5 7.2 8 2.8l5.5 4.4" fill="none" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"/><path d="M4 6.9V13h8V6.9" fill="none" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"/></svg>',
  document: '<svg viewBox="0 0 16 16"><path d="M4 2.5h4.8L12 5.7V13.5H4z" fill="none" stroke="currentColor" stroke-width="1.3" stroke-linejoin="round"/><path d="M8.8 2.5v3.2H12" fill="none" stroke="currentColor" stroke-width="1.3" stroke-linejoin="round"/><path d="M5.5 8h5M5.5 10h5" fill="none" stroke="currentColor" stroke-width="1.2" stroke-linecap="round"/></svg>',
  ...
  eye: '<svg viewBox="0 0 16 16"><ellipse cx="8" cy="8" rx="6.5" ry="4" fill="none" stroke="currentColor" stroke-width="1.3"/><circle cx="8" cy="8" r="2" fill="none" stroke="currentColor" stroke-width="1.3"/></svg>',
  refresh: '<svg viewBox="0 0 16 16"><path d="M4 8a4 4 0 1 1 1.3 3" fill="none" stroke="currentColor" stroke-width="1.4" stroke-linecap="round"/><path d="M4.5 5.5V8h2.5" fill="none" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"/></svg>',
  ...
  zen: '<svg viewBox="0 0 16 16"><path d="M2.5 3.5h11v9h-11z" fill="none" stroke="currentColor" stroke-width="1.3" stroke-linejoin="round"/><path d="M4.5 6.5h7M4.5 8.5h7M4.5 10.5h5" fill="none" stroke="currentColor" stroke-width="1.2" stroke-linecap="round"/></svg>',
  zenOff: '<svg viewBox="0 0 16 16"><path d="M2.5 3.5h11v9h-11z" fill="none" stroke="currentColor" stroke-width="1.3" stroke-linejoin="round"/><path d="M8 3.5v9" fill="none" stroke="currentColor" stroke-width="1.3"/><path d="M4.5 6.5h2M4.5 8.5h2M9.5 6.5h2M9.5 8.5h2" fill="none" stroke="currentColor" stroke-width="1.2" stroke-linecap="round"/></svg>',
  history: '<svg viewBox="0 0 16 16"><path d="M3 8a5 5 0 1 0 1.5-3.5L3 6" fill="none" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"/><path d="M3 3v3h3" fill="none" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"/><path d="M8 5.5V8.5l2 1.2" fill="none" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"/></svg>',
  ...
  grid: '<svg viewBox="0 0 16 16"><rect x="2.5" y="2.5" width="4.5" height="4.5" rx="1" fill="none" stroke="currentColor" stroke-width="1.3"/><rect x="9" y="2.5" width="4.5" height="4.5" rx="1" fill="none" stroke="currentColor" stroke-width="1.3"/><rect x="2.5" y="9" width="4.5" height="4.5" rx="1" fill="none" stroke="currentColor" stroke-width="1.3"/><rect x="9" y="9" width="4.5" height="4.5" rx="1" fill="none" stroke="currentColor" stroke-width="1.3"/></svg>',
  list: '<svg viewBox="0 0 16 16"><circle cx="3.2" cy="4.3" r="0.9" fill="currentColor"/><circle cx="3.2" cy="8" r="0.9" fill="currentColor"/><circle cx="3.2" cy="11.7" r="0.9" fill="currentColor"/><path d="M6 4.3h7.5M6 8h7.5M6 11.7h7.5" fill="none" stroke="currentColor" stroke-width="1.4" stroke-linecap="round"/></svg>',
};
